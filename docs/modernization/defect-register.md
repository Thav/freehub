...
| DEF-007 | High | Data integrity | The dump enforces 11 FKs for people/services/visits and audit users, but polymorphic notes, taggings, roles, and joins remain unenforced. Executable preflight finds 11,346 orphaned notes, 61 orphaned taggings, four unowned tags, three zero arrival datetimes, and one duplicate normalized phone. | Explicit preflight, quarantine and source = imported + quarantined reconciliation. |
