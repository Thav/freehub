...
| DEF-007 | High | Data integrity | Database schema lacks foreign keys; executable preflight finds 11,346 orphaned notes, 61 orphaned taggings, four unowned tags, three zero arrival datetimes, and one duplicate normalized phone. | Explicit preflight, quarantine and source = imported + quarantined reconciliation. |
